...
const STATUS_CONFIGS: Record<TaskStatus, StatusIconConfig> = {
  ...
  [TaskStatus.FAILED]: {
    icon: AlertCircleIcon,
    color: "text-omar-ai-red-light-9",
  },
...
export const TaskItem: React.FC<TaskItemProps> = ({ task }) => {
  ...
  return (
    <Link href={`/tasks/${task.id}`} className="block">
      <div className="bg-omar-ai-bronze-light-2 border-omar-ai-bronze-light-7 hover:bg-omar-ai-bronze-light-3 flex min-h-24 items-start rounded-lg border p-5 transition-colors">
        <div className="mb-0.5 flex-1 space-y-2">
          ...
          <div className="ml-7 flex items-center justify-start space-x-1.5 text-xs">
            <span className="text-omar-ai-bronze-light-10">
