        ...
        <div className="mx-auto max-w-3xl">
          ...
          {isLoading ? (
            <div className="p-8 text-center">
              <div className="border-omar-ai-bronze-light-5 border-t-omar-ai-bronze mx-auto mb-4 h-8 w-8 animate-spin rounded-full border-4"></div>
              <p className="text-gray-500">Loading tasks...</p>
            </div>
          ) : tasks.length === 0 ? (
            <div className="bg-omar-ai-bronze-light-2 border-omar-ai-bronze-light-7 rounded-xl border p-8 text-center">
              <div className="flex flex-col items-center justify-center">
                <h3 className="text-omar-ai-bronze-light-12 mb-1 text-lg font-medium">
                  No tasks yet
                </h3>
                <p className="text-omar-ai-bronze-light-11 mb-6 text-sm">
                  Get started by creating a first task
                </p>
                <Link href="/">
                  <Button className="bg-omar-ai-bronze-dark-7 hover:bg-omar-ai-bronze-dark-6 text-white">
                    + New Task
                  </Button>
                </Link>
              </div>
