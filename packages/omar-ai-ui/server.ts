...
// Backend URLs
const OMAR_AI_AGENT_BASE_URL = process.env.OMAR_AI_AGENT_BASE_URL;
const OMAR_AI_DESKTOP_VNC_URL = process.env.OMAR_AI_DESKTOP_VNC_URL;
...
app
  ...
  .then(() => {
    ...
    expressApp.use("/api/proxy/websockify", (req, res) => {
      ...
      // Rewrite path
      const targetUrl = new URL(OMAR_AI_DESKTOP_VNC_URL!);
      req.url =
        targetUrl.pathname +
